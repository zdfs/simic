export const ZDFS_AVATAR = 'https://avatars.githubusercontent.com/u/619628?v=4';
export const BERNARD_AVATAR =
	'https://avatars.githubusercontent.com/u/31113941?v=4';
export const THEO_AVATAR =
	'https://avatars.githubusercontent.com/u/68236786?v=4';
export const GLODIE_AVATAR =
